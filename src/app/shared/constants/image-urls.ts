export const IMAGES = {
  ...
  ADD_FILE: 'assets/img/add reaction.png',
  HORIZONTAL_LINE: 'assets/img/Vector 4.png',
  ADD_EMOJI: 'assets/img/sentiment_satisfied.png',
  ADD_PERSON_LINK: 'assets/img/alternate_email.png',
  SEND_MESSAGE: 'assets/img/send.png',
};
